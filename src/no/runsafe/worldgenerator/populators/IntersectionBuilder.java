...
public class IntersectionBuilder extends Road
{
	...
	private final Material[][][] intersection = new Material[][][]{
		...
		{
			{Material.GLOWSTONE, Material.AIR, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.AIR, Material.GLOWSTONE},
			{Material.AIR, Material.AIR, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.AIR, Material.AIR},
			{Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP},
			{Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP},
			{Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP},
			{Material.AIR, Material.AIR, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.AIR, Material.AIR},
			{Material.GLOWSTONE, Material.AIR, Material.WOOD_STEP, Material.WOOD_STEP, Material.WOOD_STEP, Material.AIR, Material.GLOWSTONE},
